<template>
	<input ref="imageInput" type="file" class="hidden" multiple accept="image/*" @change="onChange" />
	<base-image v-bind="$attrs" class="w-32 h-32 bg-surface-500 text-5xl rounded-full cursor-pointer" :src="imageURL" @click="imageInput.click()" />
</template>
