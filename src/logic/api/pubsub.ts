import { StreamEvent as StreamChatEvent, StreamEventsResponse } from "@harmony-dev/harmony-web-sdk/dist/gen/chat/v1/stream";
...
const chatEventsHandler = new Handler<StreamChatEvent["event"]>({
	...
	async sentMessage(host, { sentMessage }) {
		...
		if (params.host == host && params.guild === sentMessage.guildId && params.channel === sentMessage.channelId) {
			return;
		}
