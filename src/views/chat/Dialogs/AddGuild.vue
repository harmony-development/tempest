...
<template>
	<form class="flexcol gap-2" @submit.prevent v-if="screen === 'join'">
		...
		<div class="flex justify-end gap-2">
			...
			<HBtn variant="text" color="primary" type="submit" @click="onJoinClicked" :disabled="!joinCode">Join</HBtn>
		</div>
	</form>
	<form v-else class="flexcol gap-2" @submit.prevent>
		...
		<div class="flex justify-end gap-2">
			<HBtn variant="text" type="button" @click="close">Cancel</HBtn>
			<HBtn variant="text" color="primary" type="submit" @click="onCreateClicked" :disabled="!guildName">Create</HBtn>
		</div>
	</form>
</template>
